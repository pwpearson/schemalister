...
def get_objects_and_fields(schema):
    ...
    # Collins Avionics and Missions Migration Canidates
    standard_objects = (
        'Account',
        'Attachment',
        'CampaignMember',
        ...
        'Event',
        'GoogleDoc',
        'International_Sales_Representative__c',
        'Lead',
        'Non_Salesforce_User__c',
        'Note',
        'Offering__c',
        'Opportunity',
        'Opportunity_Forecast__c',
        'Opportunity_Line_Item__c',
        'OpportunityTeamMember',
        'Platform__c',
        'Profit_Center__c',
        'Qvidian__QPCO_Shadow__c',
        'Qvidian__QvidianProjects__c',
        'Qvidian__Qvidian_Proposal_Automation_Setting__c',
        'R_O__c',
